...
const casesData = [
    ...
    // 新增：9个地方政府合作案例 + 国家教育部项目
    {
        ...
        cooperationUnit: "国家教育部",
        projectPeriod: "2025.01.01 - 2035.12.31",
        isGovernment: true,
        link: "cases/国家教育部/index.html"
    },
    {
        id: 47,
        title: "晋江市教育改革深度合作项目",
    ...
    },
    {
        ...
        category: "policy",
        country: "中国",
        description: "与大理白族自治州教育局合作推动教育数字化转型，深化项目式学习（PBL）与社会资源对接的，建立智慧教育评估体系，促进区域教育优质均衡发展。",
        impact: "建成智慧教育示范校50所，教师数字素养提升65%，区域教育质量评估体系全面升级",
        tags: ["政府合作", "教育数字化", "智慧教育"],
        color: "green",
        icon: "fas fa-handshake",
